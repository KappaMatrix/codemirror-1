...
define('emmet/assets/range',['require','exports','module','lodash'],function(require, exports, module) {
...
define('emmet/utils/common',['require','exports','module','lodash','../assets/range'],function(require, exports, module) {
	var _ = require('lodash');
...
define('emmet/assets/handlerList',['require','exports','module','lodash'],function(require, exports, module) {
	var _ = require('lodash');
...
define('emmet/assets/elements',['require','exports','module','lodash'],function(require, exports, module) {
	var _ = require('lodash');
	var factories = {};
...
define('emmet/assets/preferences',['require','exports','module','lodash','../utils/common'],function(require, exports, module) {
	var _ = require('lodash');
	var utils = require('../utils/common');
...
define('emmet/assets/caniuse',['require','exports','module','lodash','./preferences'],function(require, exports, module) {
	var _ = require('lodash');
...
define('emmet/editTree/css',['require','exports','module','lodash','../utils/common','./base','../parser/css','../utils/cssSections','../assets/range','../assets/stringStream','../assets/tokenIterator'],function(require, exports, module) {
	var _ = require('lodash');
	var utils = require('../utils/common');
	var editTree = require('./base');
	var cssParser = require('../parser/css');
...
define('emmet/assets/resources',['require','exports','module','lodash','./handlerList','../utils/common','./elements','../assets/logger','../vendor/stringScore','../resolver/css'],function(require, exports, module) {
	var _ = require('lodash');
...
define('emmet/assets/tabStops',['require','exports','module','lodash','../utils/common','./stringStream','./resources'],function(require, exports, module) {
	var _ = require('lodash');
	var utils = require('../utils/common');
...
define('emmet/assets/profile',['require','exports','module','lodash','../utils/common','./resources','./preferences'],function(require, exports, module) {
	var _ = require('lodash');
	var utils = require('../utils/common');
	var resources = require('./resources');
	var prefs = require('./preferences');
...
define('emmet/resolver/tagName',['require','exports','module','lodash'],function(require, exports, module) {
	var _ = require('lodash');
...
define('emmet/utils/abbreviation',['require','exports','module','lodash','../assets/elements','../assets/tabStops','../utils/common','../resolver/tagName'],function(require, exports, module) {
	var _ = require('lodash');
...
define('emmet/filter/format',['require','exports','module','lodash','../utils/common','../utils/abbreviation','../assets/preferences','../assets/resources'],function(require, exports, module) {
	var _ = require('lodash');
	var utils = require('../utils/common');
...
define('emmet/filter/html',['require','exports','module','lodash','../utils/abbreviation','../utils/common','../assets/tabStops','./format'],function(require, exports, module) {
	var _ = require('lodash');
	var abbrUtils = require('../utils/abbreviation');
	var utils = require('../utils/common');
	var tabStops = require('../assets/tabStops');
...
define('emmet/filter/haml',['require','exports','module','lodash','../utils/common','../utils/abbreviation','./format'],function(require, exports, module) {
	var _ = require('lodash');
	var utils = require('../utils/common');
	var abbrUtils = require('../utils/abbreviation');
	var formatFilter = require('./format');
...
define('emmet/filter/jade',['require','exports','module','lodash','../utils/common','../utils/abbreviation','./format','../assets/tabStops','../assets/profile'],function(require, exports, module) {
	var _ = require('lodash');
	var utils = require('../utils/common');
	var abbrUtils = require('../utils/abbreviation');
	var formatFilter = require('./format');
...
define('emmet/filter/slim',['require','exports','module','lodash','../utils/common','../utils/abbreviation','./format','../assets/tabStops','../assets/preferences','../assets/profile'],function(require, exports, module) {
	var _ = require('lodash');
	var utils = require('../utils/common');
	var abbrUtils = require('../utils/abbreviation');
	var formatFilter = require('./format');
...
define('emmet/filter/xsl',['require','exports','module','lodash','../utils/abbreviation'],function(require, exports, module) {
	var _ = require('lodash');
	var abbrUtils = require('../utils/abbreviation');
...
define('emmet/filter/css',['require','exports','module','lodash'],function(require, exports, module) {
	var _ = require('lodash');
...
define('emmet/filter/bem',['require','exports','module','lodash','./html','../assets/preferences','../utils/abbreviation','../utils/common'],function(require, exports, module) {
	var _ = require('lodash');
...
define('emmet/filter/escape',['require','exports','module','lodash'],function(require, exports, module) {
	var _ = require('lodash');
	var charMap = {
		'<': '&lt;',
		'>': '&gt;',
...
define('emmet/filter/singleLine',['require','exports','module','lodash','../utils/abbreviation'],function(require, exports, module) {
	var _ = require('lodash');
	var abbrUtils = require('../utils/abbreviation');
	var rePad = /^\s+/;
	var reNl = /[\n\r]/g;
...
define('emmet/filter/trim',['require','exports','module','lodash','../assets/preferences'],function(require, exports, module) {
	var _ = require('lodash');
	var prefs = require('../assets/preferences');
...
define('emmet/filter/main',['require','exports','module','lodash','../utils/common','../assets/profile','../assets/resources','./html','./haml','./jade','./slim','./xsl','./css','./bem','./comment','./escape','./singleLine','./trim'],function(require, exports, module) {
	var _ = require('lodash');
	var utils = require('../utils/common');
	var profile = require('../assets/profile');
	var resources = require('../assets/resources');
...
define('emmet/generator/lorem',['require','exports','module','lodash','../assets/preferences'],function(require, exports, module) {
	var _ = require('lodash');
	var prefs = require('../assets/preferences');
...
define('emmet/parser/processor/pastedContent',['require','exports','module','lodash','../../utils/common','../../utils/abbreviation','../../assets/stringStream','../../assets/range'],function(require, exports, module) {
	var _ = require('lodash');
	var utils = require('../../utils/common');
	var abbrUtils = require('../../utils/abbreviation');
	var stringStream = require('../../assets/stringStream');
...
define('emmet/parser/processor/tagName',['require','exports','module','lodash','../../resolver/tagName'],function(require, exports, module) {
	var _ = require('lodash');
	var tagName = require('../../resolver/tagName');
...
define('emmet/parser/processor/resourceMatcher',['require','exports','module','lodash','../../assets/resources','../../assets/elements','../../utils/common','../../utils/abbreviation'],function(require, exports, module) {
	var _ = require('lodash');
	var resources = require('../../assets/resources');
	var elements = require('../../assets/elements');
	var utils = require('../../utils/common');
...
define('emmet/parser/processor/attributes',['require','exports','module','lodash','../../utils/common'],function(require, exports, module) {
	var _ = require('lodash');
	var utils = require('../../utils/common');
...
define('emmet/parser/abbreviation',['require','exports','module','lodash','../assets/tabStops','../assets/profile','../filter/main','../utils/common','../utils/abbreviation','../assets/stringStream','../generator/lorem','./processor/pastedContent','./processor/tagName','./processor/resourceMatcher','./processor/attributes','./processor/href'],function(require, exports, module) {
	var _ = require('lodash');
	var tabStops = require('../assets/tabStops');
	var profile = require('../assets/profile');
...
define('emmet/plugin/file',['require','exports','module','lodash'],function(require, exports, module) {
	var _ = require('lodash');
	var fs = {};
	var path = {};
...
define('emmet/utils/editor',['require','exports','module','lodash','./common','../assets/resources'],function(require, exports, module) {
	var _ = require('lodash');
	var utils = require('./common');
	var resources = require('../assets/resources');
...
define('emmet/resolver/gradient/linear',['require','exports','module','lodash','../../assets/stringStream','../../utils/common'],function(require, exports, module) {
	var _ = require('lodash');
	var stringStream = require('../../assets/stringStream');
	var utils = require('../../utils/common');
...
define('emmet/resolver/cssGradient',['require','exports','module','lodash','../assets/preferences','../assets/resources','../utils/common','../assets/stringStream','./css','../assets/range','../editTree/css','../utils/editor','./gradient/linear'],function(require, exports, module) {
	var _ = require('lodash');
	var prefs = require('../assets/preferences');
	var resources = require('../assets/resources');
	var utils = require('../utils/common');
...
define('emmet/action/expandAbbreviation',['require','exports','module','lodash','../assets/handlerList','../assets/range','../assets/preferences','../utils/common','../utils/editor','../utils/action','../resolver/cssGradient','../parser/abbreviation'],function(require, exports, module) {
	var _ = require('lodash');
...
define('emmet/action/incrementDecrement',['require','exports','module','lodash','../utils/common','../utils/action'],function(require, exports, module) {
	var _ = require('lodash');
	var utils = require('../utils/common');
	var actionUtils = require('../utils/action');
...
define('emmet/action/lineBreaks',['require','exports','module','lodash','../assets/preferences','../utils/common','../assets/resources','../assets/htmlMatcher','../utils/editor'],function(require, exports, module) {
	var _ = require('lodash');
	var prefs = require('../assets/preferences');
	var utils = require('../utils/common');
	var resources = require('../assets/resources');
...
define('emmet/action/balance',['require','exports','module','lodash','../assets/htmlMatcher','../utils/common','../utils/editor','../utils/action','../assets/range','../editTree/css','../utils/cssSections'],function(require, exports, module) {
	var _ = require('lodash');
	var htmlMatcher = require('../assets/htmlMatcher');
	var utils = require('../utils/common');
	var editorUtils = require('../utils/editor');
...
define('emmet/action/reflectCSSValue',['require','exports','module','lodash','../assets/handlerList','../assets/preferences','../resolver/css','../editTree/css','../utils/common','../utils/action','../utils/editor','../resolver/cssGradient'],function(require, exports, module) {
	var _ = require('lodash');
	var handlerList = require('../assets/handlerList');
	var prefs = require('../assets/preferences');
	var cssResolver = require('../resolver/css');
...
define('emmet/action/selectItem',['require','exports','module','lodash','../assets/range','../utils/editor','../utils/action','../assets/stringStream','../parser/xml','../editTree/css','../utils/cssSections'],function(require, exports, module) {
	var _ = require('lodash');
	var range = require('../assets/range');
	var editorUtils = require('../utils/editor');
	var actionUtils = require('../utils/action');
...
define('emmet/action/toggleComment',['require','exports','module','lodash','../assets/preferences','../assets/range','../utils/common','../utils/action','../utils/editor','../assets/htmlMatcher','../editTree/css'],function(require, exports, module) {
	var _ = require('lodash');
	var prefs = require('../assets/preferences');
	var range = require('../assets/range');
	var utils = require('../utils/common');
...
define('emmet/action/updateImageSize',['require','exports','module','lodash','../utils/editor','../utils/action','../editTree/xml','../editTree/css','../utils/base64','../plugin/file'],function(require, exports, module) {
	var _ = require('lodash');
	var editorUtils = require('../utils/editor');
	var actionUtils = require('../utils/action');
	var xmlEditTree = require('../editTree/xml');
...
define('emmet/action/wrapWithAbbreviation',['require','exports','module','lodash','../assets/range','../assets/htmlMatcher','../utils/common','../utils/editor','../utils/action','../parser/abbreviation'],function(require, exports, module) {
	var _ = require('lodash');
	var range = require('../assets/range');
	var htmlMatcher = require('../assets/htmlMatcher');
	var utils = require('../utils/common');
...
define('emmet/action/updateTag',['require','exports','module','lodash','../editTree/xml','../utils/editor','../utils/action','../utils/common','../parser/abbreviation'],function(require, exports, module) {
	var _ = require('lodash');
	var xmlEditTree = require('../editTree/xml');
	var editorUtils = require('../utils/editor');
	var actionUtils = require('../utils/action');
